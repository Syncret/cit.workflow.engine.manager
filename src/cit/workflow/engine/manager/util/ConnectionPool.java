...
public class ConnectionPool {
	private String jdbcDriver = Constants.CONN_DIRVER; // 数据库驱动
	private String dbUrl = Constants.CONN_URL; // 数据 URL
	private String dbUsername = Constants.CONN_USERNAME; // 数据库用户名
	private String dbPassword = Constants.CONN_PASSWORD; // 数据库用户密码
...
//			System.out.println(" 连接池不存在，无法关闭 !");
		...
		connections = null;
		System.out.println("Connections All Closed");
	}
